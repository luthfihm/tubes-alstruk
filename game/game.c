...

{
	...
	char *help[] = {
		...
		" ",
		"# viewmap <koordinat-goalcard-y> <koordinat-goalcard-x>",
		...
		" ",
		"# rockfall <koordinat y> <koordinat x>",
		"  Melakukan rockfall pada koordinat yang ditentukan",
		"  <koordinat y> posisi baris tempat rockfall akan dilakukan",
		"  <koordinat x>  posisi kolom tempat rockfall akan dilakukan",
		" ",
		"# draw",
